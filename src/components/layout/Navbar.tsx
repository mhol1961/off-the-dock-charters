...
export default function Navbar() {
  ...
  return (
    <nav className="bg-black/90 py-4 px-4 md:px-8 sticky top-0 z-50 shadow-xl shadow-black/30 border-b border-[#D59633]/20">
        ...
        <Link href="/" className="flex items-center">
          <div className="relative">
            <Image
              ...
              width={120}  /* Made much larger for better visibility */
              height={120}
