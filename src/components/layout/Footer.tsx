      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-xl font-heading font-bold text-primary mb-4">Off The Dock Charters</h3>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">Bradenton, Florida</li>
              <li><a href="tel:+1234567890" className="text-gray-300 hover:text-primary">Phone: (123) 456-7890</a></li>
              <li><a href="mailto:info@offthedockcharters.com" className="text-gray-300 hover:text-primary">info@offthedockcharters.com</a></li>
            </ul>
          </div>
